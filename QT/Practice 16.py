# Practice 16 - Exit button

import sys
from PyQt5.QtWidgets import QApplication, QDesktopWidget, QMainWindow, QWidget, QPushButton, QMessageBox
...
class MyApp(QMainWindow):
    ...
    def setwindow(self):
        self.setWindowTitle("QT-Practice 16")
